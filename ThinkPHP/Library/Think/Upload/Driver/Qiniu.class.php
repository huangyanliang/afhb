...
class Qiniu{
    ...
    private $config = array(
        'accessKey'      => 'K3eWBNa_ZGTQcdh0QlzmOyrAVEfGLWyRn15k-yZt', //七牛服务器
        'secrectKey'     => '4q7SuMGgdGpGzrI0ZlDjHZrBxrXxMP68Po5hycl6', //七牛用户
        'domain'         => 'http://oq72l9f0o.bkt.clouddn.com', //七牛密码
        'bucket'         => 'jxbh', //空间名称
        'timeout'        => 300, //超时时间
    );
