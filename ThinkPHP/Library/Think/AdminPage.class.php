...
class AdminPage {
	...
	private function pageList() {
		...
		for ($i=$this->_bothnum;$i>=1;$i--) {
			$_page = $this->_page-$i;
			if ($_page < 1) continue;
			$_pagelist .= '<li><a href="'.U($this->_url,$this->url($_page)).'">'.$_page.'</a></li>';
		}
	...
	private function prev() {
		...
		return '<li><a href="'.U($this->_url,$this->url($this->_page-1)).'" data-toggle="tooltip" data-placement="top" title="上一页" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>';
	}
	//下一页
	private function next() {
		...
		return ' <li><a href="'.U($this->_url,$this->url($this->_page+1)).'" data-toggle="tooltip" data-placement="top" title="下一页" aria-label="Next"><span aria-hidden="true">&raquo;</span></a></a> ';
	}
	//尾页
	private function last() {
		if ($this->_pagenum - $this->_page > $this->_bothnum) {
			return ' <li><a href="javascript:void(0)">...</a></li><li><a href="'.U($this->_url,$this->url($this->_pagenum)).'">'.$this->_pagenum.'</a></li>';
		}
	}
	  //跳转到
	private function jump(){
	   $val = ($this->_page < $this->_pagenum) ? $this->_page+1 : $this->_page;	
	   return '<div class="input-group input-group-sm pull-left" style="width:100px;"><input type="hidden" value="'.U($this->_url,$this->url(0)).'" name="jump_url" class="jump_url" /><input type="text" value="'.$val.'" max="'.$this->_pagenum.'" onKeyUp="if(this.value>'.$this->_pagenum.'){this.value='.$this->_pagenum.'}" name="page" class="form-control page_num"><span class="input-group-addon jump_go" data-toggle="tooltip" data-placement="top" title="点击跳转到页码"><span class="glyphicon glyphicon-share-alt"></span></span></div>';
	}
	  //分页信息
