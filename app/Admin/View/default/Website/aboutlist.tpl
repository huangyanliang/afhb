...
<block name="main">
 ...
 <h1>资料管理<div class="pull-right">{:btn(array('vals'=>'添加资料','size'=>3,'icon'=>'plus','scene'=>'primary','url'=>U('website/aboutadd','tables='.$dshow['table'].'&sty='.$sty)))}</div></h1>
 <if condition="$data neq ''">
  <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="{:tabstyle()}">
   ...
   <tr class="maintr">
    ...
    <td align="center" valign="middle">{:btn(array('vals'=>'编辑','icon'=>'edit','tips'=>'点击编辑数据','url'=>U('website/aboutmod','tables='.$dshow['table'].'&id='.$obj['Id'])))}</td>
   </tr>
   </volist>
   <tr>
