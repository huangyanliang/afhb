...
<block name="main">
 <div class="pubmain">
 <h1>客服管理<div class="pull-right">{:btn(array('vals'=>'添加客服','size'=>3,'icon'=>'plus','scene'=>'primary','url'=>U('website/onlineadd','tables='.$dshow['table'])))}</div></h1>
 ...
 <form name="publist" method="post" action="" onSubmit="return pubdel(document.publist)"> 
  <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="{:tabstyle()}">
   ...
   <tr class="maintr">
    ...
    <td align="center" valign="middle">{:btn(array('vals'=>'编辑','icon'=>'edit','tips'=>'点击编辑数据','url'=>U('website/onlinemod','tables='.$dshow['table'].'&id='.$obj['Id'])))}</td>
   </tr>
   </volist>
   <tr>
