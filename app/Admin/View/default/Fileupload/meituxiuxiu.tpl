...
<block name="main">
 <div class="" style="margin-bottom:10px;">
  <if condition="$act eq ''">
   {:btn(array('vals'=>'在线拼图','faicon'=>'puzzle-piece','size'=>3,'url'=>U('Fileupload/meituxiuxiu')))}
   {:btn(array('vals'=>'美化图片','icon'=>'picture','scene'=>'default','size'=>3,'url'=>U('Fileupload/meituxiuxiu','act=edit')))}
   {:btn(array('vals'=>'在线美图','faicon'=>'magic','scene'=>'default','size'=>3,'url'=>U('Fileupload/meituxiuxiu','act=online')))}
  </if>
  <if condition="$act eq 'edit'">
   {:btn(array('vals'=>'在线拼图','faicon'=>'puzzle-piece','scene'=>'default','size'=>3,'url'=>U('Fileupload/meituxiuxiu')))}
   {:btn(array('vals'=>'美化图片','icon'=>'picture','size'=>3,'url'=>U('Fileupload/meituxiuxiu','act=edit')))}
   {:btn(array('vals'=>'在线美图','faicon'=>'magic','scene'=>'default','size'=>3,'url'=>U('Fileupload/meituxiuxiu','act=online')))}
  </if>
  <if condition="$act eq 'online'">
   {:btn(array('vals'=>'在线拼图','faicon'=>'puzzle-piece','scene'=>'default','size'=>3,'url'=>U('Fileupload/meituxiuxiu')))}
   {:btn(array('vals'=>'美化图片','icon'=>'picture','scene'=>'default','size'=>3,'url'=>U('Fileupload/meituxiuxiu','act=edit')))}
   {:btn(array('vals'=>'在线美图','faicon'=>'magic','size'=>3,'url'=>U('Fileupload/meituxiuxiu','act=online')))}
  </if>
 </div>
