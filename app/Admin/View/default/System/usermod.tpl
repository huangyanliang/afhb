 ...
 <h1>编辑管理员</h1>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="{:tabstyle()}">
   <tr>
    ...
    <td height="32" align="left">{:input(array('name'=>'user','val'=>$data['user'],'icon'=>'user','width'=>15,'disabled'=>1))}</td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">姓名：</td>
     <td height="32" align="left">{:input(array('name'=>'name','val'=>$data['realname'],'icon'=>'user','width'=>15))}</td>
   </tr>
   <tr>
   ...
   <tr>
     ...
     <td height="32" align="left">{:input(array('type'=>'password','name'=>'pass','icon'=>'log-out','width'=>30,'place'=>'修改密码','tips'=>'长度大于6位，支持大小写，留空表示不修改密码'))}</td>
   </tr>
   <tr>
