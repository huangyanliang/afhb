  ...
  <form name="sysmod" method="post" action="" onSubmit="return sysck(document.sysmod)">
    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="{:tabstyle()}">
      ...
      <tr>
        ...
        <td height="42" align="left">{:input(array('name'=>'wateralpha','val'=>$data['wateralpha'],'tips'=>'水印透明度，1-100的整数','icon'=>'tint','width'=>'10'))}</td>
      </tr>
      <tr>
        <td height="42" align="right" valign="middle">水印文字：</td>
        <td height="42" align="left">{:input(array('name'=>'fonttext','val'=>$data['fonttext'],'tips'=>'水印文字，建议用字母或文字','units'=>'文','width'=>'20'))}</td>
      </tr>
      <tr>
        <td height="42" align="right" valign="middle">文字大小：</td>
        <td height="42" align="left">{:input(array('name'=>'fontsize','val'=>$data['fontsize'],'tips'=>'水印文字的大小','units'=>'px','width'=>'10'))}</td>
      </tr>
      <tr>
