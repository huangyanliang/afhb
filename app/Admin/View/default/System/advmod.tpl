 ...
 <div class="pubmain">
  ...
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="{:tabstyle()}">
   <tr>
    ...
    <td height="32" align="left">{:input(array('type'=>'text','icon'=>'flag','name'=>'topic','place'=>'广告标题','val'=>$data['topic'],'tips'=>'输入广告标题'))}</td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">广告链接：</td>
     <td height="32" align="left">{:input(array('type'=>'text','scene'=>'link','name'=>'linkurl','place'=>'广告链接','val'=>$data['linkurl'],'tips'=>'输入广告链接'))}</td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">广告位置：</td>
     <td height="32" align="left">
      {:dropdown($advtype,$data['ctag'],'选择广告位置','ctag')}
     </td>
   </tr>
   <tr class="hide">
     <td height="32" align="right" valign="middle">广告备注：</td>
     <td height="32" align="left">{:input(array('type'=>'text','name'=>'remark','place'=>'广告备注','val'=>$data['remark']))}</td>
   </tr>
   <tr>
   ...
   <tr class="hide">
     ...
     <td height="32" align="left">
      {:input(array('type'=>'text','units'=>'px','name'=>'picwidth','val'=>$data['picwidth'],'place'=>'图片宽度','width'=>'20'))} 
      {:input(array('type'=>'text','units'=>'px','name'=>'picheight','val'=>$data['picheight'],'place'=>'图片高度','width'=>'20'))} 
     </td>
   </tr>
   <tr>
   ...
   <tr>
     ...
     <td height="32" align="left">{:input(array('type'=>'text','scene'=>'ord','name'=>'ord','place'=>'排序','val'=>$data['ord']))}</td>
   </tr>
   <tr>
