 ...
 <div class="pubmain">
  ...
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="{:tabstyle()}">
   <tr>
    ...
    <td height="32" align="left">{:input(array('type'=>'text','icon'=>'flag','place'=>'广告标题','name'=>'topic','tips'=>'输入广告标题'))}</td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">广告链接：</td>
     <td height="32" align="left">{:input(array('type'=>'text','scene'=>'link','place'=>'广告链接','name'=>'linkurl','tips'=>'输入广告链接'))}</td>
   </tr>
   <tr class="hide">
     <td height="32" align="right" valign="middle">广告备注：</td>
     <td height="32" align="left">{:input(array('type'=>'text','name'=>'remark'))}</td>
   </tr>
   <tr>
   ...
   <tr class="hide">
     ...
     {:input(array('type'=>'text','units'=>'px','name'=>'picwidth','val'=>0,'width'=>'20'))} 
     {:input(array('type'=>'text','units'=>'px','name'=>'picheight','val'=>0,'width'=>'20'))} 
     </td>
   </tr>
   <tr>
