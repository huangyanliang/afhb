...
<block name="main">
 <div class="pubmain">
  ...
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="{:tabstyle()}">
   <tr>
     ...
     <td height="32" align="left">{:input(array('units'=>'注','name'=>'title','tips'=>'栏目名称','width'=>20,'place'=>'栏目名称'))}</td>
   </tr>
   <tr>
     <td width="10%" height="32" align="right" valign="middle">栏目图标：</td>
     <td height="32" align="left" class="icontd">{:input(array('faicon'=>'code','name'=>'icon','add'=>'code','tips'=>'栏目图标','width'=>20,'place'=>'栏目图标'))}</td>
   </tr>
   <tr>
   ...
   <tr class="linktr" style="display:none;">
     ...
     <td height="32" align="left">{:input(array('faicon'=>'link','name'=>'linkurl','tips'=>'参数和方法名之间用,隔开 例如：Website/datalist,tables=information&sty=2','width'=>40,'place'=>'栏目链接 Website/datalist,tables=information&sty=2'))}</td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">栏目排序：</td>
     <td height="32" align="left">{:input(array('type'=>'text','scene'=>'ord','name'=>'ord','val'=>0))}</td>
   </tr>
   ...
   <tr class="opentr" style="display:none;">
     ...
     <td height="32" align="left">{:checkbox(1,0,'isopen')} <span class="text-warning"> 注：是否默认展开项目。</span></td>
   </tr>
 ...
 <script type="text/javascript">
  ...
  function showMenu(id) {
    if ( id ) {
	  $.post("{:U('Admin/getMenu')}",{'id':id},function(data){
	    if (data!='') {
