...
<head>
 ...
 <meta name="description" content="登录澳菲环保后台管理系统 {:C('ADMIN_VERSION')}">
 <meta name="keywords" content="登录澳菲环保后台管理系统  {:C('ADMIN_VERSION')}">
...
<if condition="$data['adminpath'] eq ''">
 ...
 <div class="i-login">
   <div class="logo"><!--<img src="__img__/logo.png">-->澳菲环保后台管理系统</div>
