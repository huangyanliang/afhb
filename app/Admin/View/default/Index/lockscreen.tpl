...
<head>
 ...
 <meta name="description" content="{<:C('SYSTEMNAME')>}明良广 {<:C('ADMIN_VERSION')>}">
 <meta name="keywords" content="{<:C('SYSTEMNAME')>}明良广 {<:C('ADMIN_VERSION')>}">
 <link rel="shortcut icon" href="__img__/favicon.ico" />
 <meta name="author" content="jxbh">
 <title>{<$title>} - 明良广</title>
<style>
...
<body>
 ...
 <script type="text/javascript">
   $(".btn-login").click(function(e) {
	 ...
	 $.post('{<:U("Index/ajaxLock")>}',{'user':user,'pass':pass},function(data){
