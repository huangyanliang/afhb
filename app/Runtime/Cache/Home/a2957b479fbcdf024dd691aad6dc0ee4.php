...
<head>
	...
	<div class="main">
		<div class="addressBox">
			 <img src="/23mlg/public/Home/images/home.png"/><a href="<?php echo U('index/index');?>">首页</a> > <a href="<?php echo U('product/index');?>">产品中心</a> > <?php echo ($title); ?>
		</div>
		<div class="menuBox">
			<?php if(is_array($proMenu)): $i = 0; $__LIST__ = $proMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$proMenuobj): $mod = ($i % 2 );++$i;?><a class="hvr-radial-out" <?php if($type == $proMenuobj['Id']): ?>style="background-color:#05B181;color:#fff;"<?php else: endif; ?> href="<?php echo U('product/index','type='.$proMenuobj['Id']);?>"><?php echo ($proMenuobj['topic']); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
		</div>
		<?php echo ($pageshow); ?>
	</div>
